...
# source('ui_app_arcdrilldown.R', local = TRUE)
# source('ui_app_mordrilldown.R', local = TRUE)
# source('ui_app_MORxxx.R', local = TRUE)
...
body <- dashboardBody(
  tabItems(
    ...
    # tabItem_rms_design,
    # tabItem_app_master,
    # tabItem_app_arcdrilldown,
    # tabItem_app_mordrilldown,
    # tabItem_app_morxxx
